...
class StudentRegistration(models.Model):
    ...
    communication_country_id = fields.Many2one("res.country", required=False, string="Communication Country")
    ...
    permanent_country_id = fields.Many2one("res.country", required=False, string="Permanent Country")
